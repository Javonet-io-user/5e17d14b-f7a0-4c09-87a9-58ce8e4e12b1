...
public class AttachEventArgs extends EventArgs {
  ...
  public AttachEventArgs(Phidget phidget) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Phidgets.Events.AttachEventArgs", phidget);
  ...
  public AttachEventArgs(NObject handle) {
    super(handle);
