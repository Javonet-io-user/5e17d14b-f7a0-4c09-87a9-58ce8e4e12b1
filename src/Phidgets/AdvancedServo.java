...
public class AdvancedServo extends Phidget {
  protected NObject javonetHandle;
  /** GetFiled */
  @MethodTypeAnnotation(type = "GetField")
  public AdvancedServoServoCollection getservos() {
    try {
      Object res = javonetHandle.<NObject>get("servos");
      if (res == null) return null;
      return new AdvancedServoServoCollection((NObject) res);
  ...
  public void setservos(AdvancedServoServoCollection param) {
    try {
  ...
  public AdvancedServo() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Phidgets.AdvancedServo");
  ...
  public AdvancedServo(NObject handle) {
    super(handle);
